...
const char *
dnf_dpgettext(const char * domain, const char * context, const char * msgId)
{
...
const char *
dnf_dpgettext2(const char * domain, const char * ctxMsgId, size_t msgIdOffset)
{
    const char * const translation = dgettext(domain, ctxMsgId);
    if (translation == ctxMsgId)
...
const char *
dnf_dnpgettext(const char * domain, const char * context, const char * msgId, const char * msgIdPlural, unsigned long int n)
{
    size_t context_len = strlen(context) + 1;
    size_t msgId_len = strlen(msgId) + 1;
    char ctxMsgId[context_len + msgId_len];
...
const char *
dnf_dnpgettext2(const char * domain, const char * ctxMsgId, size_t msgIdOffset, const char * msgIdPlural, unsigned long int n)
{
    const char * const translation = dngettext(domain, ctxMsgId, msgIdPlural, n);
    if (translation == ctxMsgId)
        return ctxMsgId + msgIdOffset;
...
const char *
dnf_dmgettext(const char * domain, const char * markedMsg, unsigned long int n)
{
    if (*markedMsg & 0x01) {
